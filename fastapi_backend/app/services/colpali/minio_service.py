...
class MinioService:
    ...
    def __init__(self):
        ...
        try:
            ...
            url_parts = settings.MINIO_URL.replace("http://", "").replace("https://", "")
    ...
    def set_public_policy(self):
        ...
        try:
            ...
            logger.warning(f"Could not set public policy for bucket {self.bucket_name}: {e}")
    ...
    def get_presigned_url(self, image_id: str, expires: timedelta = timedelta(hours=1)) -> str:
        """
